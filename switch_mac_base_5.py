#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @brief:     switch_mac_base_5.py - 测试交换机批量删除指定VLAN下动态地址
...
def switch_mac_base_5(cb_arg):
    ...
    print "clear vlan number test is over "
    return result
